...
%>
	...
	<%
		if(c!= null){
			%>
			<h2><%=name %>님의 아이디는 &nbsp<big><big><font color="#f08b07"><%=c.getId()%></font></big></big> 입니다.</h2>
			<p><br><br>
			<input type="button" value="비밀번호 찾기"  class="my_box3" onclick="location.href='searchPwForm.jsp'">
			<input type="submit" value="로그인하기" class="my_box3">
			
			<%
		}else{
			%>
			<H2>이름 또는 학번이 틀렸습니다!<br>다시 입력해 주세요<p></H2><br><br>
			<input type="button" value="다시 입력하기" class="my_box3" onclick="location.href='searchIdForm.jsp'">
		<%
		}%>
	</font>
	</div>
