...
<body>
   ...
   <center>
      <div class="div_a">
         ...
         <br>
         <br>
         <br> <font face="함초롬돋움"> <img src="image/success.png" /><br>
         <br>
            <h2>회원가입이 완료 되었습니다 :)</h2>
            <h4>
               <font class="font_a"><%=name%></font>&nbsp&nbsp님의 회원가입을 축하합니다! <br>
               <br>
            </h4>
            <hr width="500" color="lightgray">
            <br>
            <button type="submit" class="button_a"
               onclick="location.href='main.jsp'">
               <img src="image/start.png" width="390" height="60" alt="submit" /></font>
      </div>
   </center>
   <%
      }
