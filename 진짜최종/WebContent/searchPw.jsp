   ...
   <center>
      <form method="post" action="main.jsp">
         ...
         <div class="div_a">
            ...
            <br>
            <br>
            <br> <font face="함초롬돋움"> <img src="image/find.png" /><br>
            <br> <%
    if (c != null) {
 %>
               <h2><%=id%>님의 비밀번호는&nbsp<big><big><font
                        color="#f08b07"><%=c.getPasswd()%></font></big></big>입니다.
               </h2>
               <p>
                  <br>
                  <br> <input type="submit" value="로그인하기" class="my_box3">
                  <%
                     } else {
                  %>
               
               <h2>
                  아이디 또는 학번이 틀렸습니다!<br>다시 입력해 주세요
                  <p>
               </h2>
               <br>
            <br> <input type="button" value="다시 입력하기" class="my_box3"
               onclick="location.href='searchPwForm.jsp'"> <%
    }
 %>
            </font>
         </div>
