...
<body class="wallpaper">
	<%
		...
		try {
			...
			String sql_update = "update pjboard_tbl set name= '" + name + "', title = '" + title + "', content= '"
					+ content + "' where id = " + id;
	...
	<center>
		...
		<div class="table_border">
				<br>
				<big><b>게시글이 수정되었습니다.</b></big><br><br>
				<br>
				<a href="board-read.jsp?id=<%=request.getParameter("id")%>">
				<input type="button" value="글 확인" class="my_box2"
					onclick="location.href='board-list.jsp'" /></a>
					<a href="board-list.jsp"> <input type="button" value="목록" class="my_box2" />
				</a>
		</div>
	</center>
</body>
